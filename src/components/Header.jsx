export default function Header({ event, club }) {
  return <header className="border-b bg-white">
    <div className="mx-auto flex max-w-5xl flex-wrap items-center gap-3 px-4 py-4">
      <img src="/logo.svg" alt="SWIMTIMER" className="size-11" />
      <div className="mr-auto"><p className="text-lg font-bold text-brand-800">SWIMTIMER · Inscripciones</p><p className="text-sm text-slate-500">by Scanleads</p></div>
