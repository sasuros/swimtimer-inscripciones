...
export function validateAthlete(form, roster, referenceDate, editingId = null) {
  const errors = {}
  ...
  if (form.birthDate && !categoryForAge(age)) errors.birthDate = `La edad calculada (${age} años) no pertenece a las categorías del evento`
