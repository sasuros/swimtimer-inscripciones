...
const statusInfo = {
  active: ['Recibiendo inscripciones', 'bg-success-800 text-white'],
...
export default function AdminEvents() {
  ...
  return <><AdminHeader /><main className="mx-auto max-w-7xl space-y-8 p-4 sm:p-6">
    <div className="flex flex-wrap items-end justify-between gap-4"><div><p className="text-sm font-bold uppercase tracking-[.2em] text-brand-800">Panel del organizador</p><h1 className="mt-1 text-3xl font-extrabold">Mis eventos</h1><p className="mt-1 text-slate-500">Meet Manager es la fuente principal de configuración.</p></div><div className="flex flex-wrap gap-2"><a className="btn-primary inline-flex items-center gap-2 px-5 py-3" href="/admin/eventos/importar"><FileUp className="size-5" />Importar desde Meet Manager</a><a className="btn-secondary inline-flex items-center gap-2" href="/admin/eventos/nuevo"><Plus className="size-4" />Crear manualmente</a></div></div>
