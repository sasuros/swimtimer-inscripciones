...
function ClubStatus({ status }) { const map = { received: ['bg-success-800 text-white','● Recibida'], sent: ['bg-warning-50 text-warning-800','● Enlace enviado'], missing: ['bg-danger-50 text-danger-700','● Sin enlace'] }; return <span className={`rounded-full px-2.5 py-1 text-xs font-bold ${map[status][0]}`}>{map[status][1]}</span> }
